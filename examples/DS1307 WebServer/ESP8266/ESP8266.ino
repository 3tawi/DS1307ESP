...
const char* Appassword = "3tawi-GP";
  IPAddress ip(192, 168, 1, 63); // http://192.168.1.63
...
void setup() {
  Serial.begin(115200);
  rtc.begin();    // The SDA and SCL lines of the I2C bus come from GPIO4 (D2) and GPIO5 (D1) of the NodeMCU board (respectively)
  getWifi();
